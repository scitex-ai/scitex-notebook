...
# (project=scitex-notebook, owner=ywatanabe1989, repo=scitex-notebook,
...
TMPDIR="/tmp/publish-scitex_notebook-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-notebook dist/* uploaded to PyPI via manual OIDC trusted publishing"
