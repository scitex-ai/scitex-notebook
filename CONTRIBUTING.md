# Contributing to SciTeX Notebook

Thank you for your interest in contributing to SciTeX Notebook. This guide covers
...
- Search [existing issues](https://github.com/ywatanabe1989/scitex-notebook/issues)
  before opening a new one.
- Include a minimal reproducible example when reporting bugs.
- Specify your Python version, OS, and `scitex-notebook` version.

## Development Setup

```bash
git clone git@github.com:ywatanabe1989/scitex-notebook.git
cd scitex-notebook
pip install -e ".[dev]"
```
